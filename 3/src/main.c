...
int main(int argc, char** argv) {
	...
	p1_end = clock();
	printf(B_GREEN ">" B_WHITE " all intersections found " WHITE "(" BLUE "%.3f us" WHITE ")\n" RESET, (p1_end - p1_start) * 100000.0 / CLOCKS_PER_SEC);
	...
	p2_end = clock();
	printf(B_GREEN ">" B_WHITE " shortest path found " WHITE "(" BLUE "%.3f us" WHITE ")\n" RESET, (p2_end - p2_start) * 100000.0 / CLOCKS_PER_SEC);
